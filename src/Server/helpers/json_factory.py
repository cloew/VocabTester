...
from ..Language import LanguageJson
...
jsonFactory = JsonFactory({
    Symbol:AsObj(id=ViaAttr(), text=ViaAttr(), learned=ViaFn(HasLearned, requires=['learnedCache'])),
    Word:AsObj(id=ViaAttr(), text=ViaAttr(), learned=ViaFn(HasLearned, requires=['learnedCache']), data=ViaAttr()),
